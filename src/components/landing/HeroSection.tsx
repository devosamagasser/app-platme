  ...
  <section className="relative min-h-screen flex items-center pt-16 overflow-hidden">
    ...
    <div className="relative z-10 container mx-auto px-8 grid lg:grid-cols-2 gap-16 items-center">
      <div className="space-y-8">
        ...
        >
          Human-led direction. AI-powered orchestration.<br />
        ...
        >
          ...
          <button className="px-8 py-4 rounded-lg border border-primary/20 text-foreground font-medium text-sm hover:bg-primary/5 transition-all">
            Join Early Access
          </button>
        </motion.div>
      </div>
