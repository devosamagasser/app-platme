            ...
            function: {
              ...
              parameters: {
                ...
                properties: {
                  id: {
                    type: "string",
                    description: "Unique module ID (lowercase, snake_case)",
                  },
                  label: {
                    type: "string",
                  ...
                  category: {
                    type: "string",
                    description: "Module category (e.g., Security, Core, Payments)",
                  },
                  dependencies: {
                    type: "array",
                    items: { type: "string" },
                    description: "Array of module IDs this module depends on",
                  },
                },
