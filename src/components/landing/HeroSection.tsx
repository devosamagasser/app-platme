...
const HeroSection = () => {
  ...
  return (
    <section aria-labelledby="hero-heading" className="relative min-h-screen flex items-center pt-16 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-8 grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
        <div className="space-y-6 md:space-y-8">
          ...
          >
            ...
            <h1 id="hero-heading" className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-semibold tracking-architect text-foreground leading-[1.05]" style={{ textWrap: "balance" as React.CSSProperties["textWrap"] }}>
              <motion.span
