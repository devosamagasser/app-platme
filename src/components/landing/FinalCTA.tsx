    ...
    <section className="py-20 md:py-32 relative">
      ...
      <div className="relative container mx-auto px-4 md:px-8 text-center">
        ...
        >
          ...
          <Link to="/select" className="inline-block px-8 md:px-10 py-4 md:py-5 rounded-lg bg-primary text-primary-foreground font-bold text-sm hover:shadow-[0_0_30px_rgba(159,255,208,0.4)] transition-all mint-glow">
            {t("cta.button")}
          </Link>
        </motion.div>
      </div>

      <div className="relative mt-20 md:mt-32 border-t border-primary/10 pt-8">
